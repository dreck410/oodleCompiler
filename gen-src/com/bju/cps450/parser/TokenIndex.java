...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTStringConcat(@SuppressWarnings("unused") TStringConcat node)
    {
        this.index = 25;
    }
    ...
    @Override
    public void caseTOparen(@SuppressWarnings("unused") TOparen node)
    {
        this.index = 35;
    }

    @Override
    public void caseTCparen(@SuppressWarnings("unused") TCparen node)
    {
        this.index = 36;
    }
    ...
    @Override
    public void caseTIllegal(@SuppressWarnings("unused") TIllegal node)
    {
        this.index = 45;
    }
