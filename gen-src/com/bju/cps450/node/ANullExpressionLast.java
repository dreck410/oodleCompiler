...
public final class ANullExpressionLast extends PExpressionLast
{
    private TNull _null_;

    public ANullExpressionLast()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANullExpressionLast(
    ...
    {
        ((Analysis) sw).caseANullExpressionLast(this);
    }
